...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const updateScrollPosition = () => {
        if (window.scrollY === 0) {
            el_autohide.classList.add('scrolled-at-top-most');
            el_autohide.classList.remove('scrolled-at-middle');
        } else {
            el_autohide.classList.remove('scrolled-at-top-most');
            el_autohide.classList.add('scrolled-at-middle');
        }
    }
