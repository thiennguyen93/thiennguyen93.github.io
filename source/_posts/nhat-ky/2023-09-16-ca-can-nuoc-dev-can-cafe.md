...
Có lẽ bác biên kịch biết tiếng Việt nên mới dùng lối chơi chữ `CàPHê` thành `CPH4` như trong kịch bản phim. {% lotties_player className="is-inline-block animated-emoji" src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f602/lottie.json" width="1em" height="1em" autoplay loop %}
...
- Chống trầm cảm: Nếu không có cà phê, tôi có lẽ đã bỏ nghề từ lâu lắm rồi các bạn ạ {% lotties_player className="is-inline-block animated-emoji" src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f602/lottie.json" width="1em" height="1em" autoplay loop %}
