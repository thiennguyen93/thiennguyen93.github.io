...
<div class="mt-4 has-text-centered columns is-multiline is-centered mb-3">
  ...
  <div class="has-text-centered column is-one-quarter-desktop mb-3 has-tooltip-arrow has-tooltip-align-left has-tooltip-top has-tooltip-danger">
    <div class="qr-box has-ribbon-bottom px-0">
      ...
      <nav class="px-1 py-1 card card-action-nav level is-mobile">
...
<script>
  ...
  var qrNavBarButton = document.querySelectorAll("a[title='QR']")
  qrNavBarButton.forEach(item => {
